function [] = deleteWrongForRange(fileFolder,fileName,max_value,stripe_min,stripe_max)
% Borrar las columnas con los datos que tuvieron posiblemente
...
while column <= nSimus
    maxInColumn = max(datos(stripe_min:stripe_max,column));                 % Máximo valor de columna
...
elseif exist(fileDirAllSimus, 'file') == 2                                  % Si existe el archivo
    ...
    % simulaciones nuevas por lo que yppN_all_simus debe ser antiguo.
