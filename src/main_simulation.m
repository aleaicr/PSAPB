...
% Output folder path
OUTPUT_PATH = ['../results/main_analysis/bridge', num2str(bridge_num), '/results_2000s.mat'];    % Path to store all the simulations.
...
P_ped = [5, 10, 20, 30, 40, 50, 75, 100, 110, 120, 125, 130, 140, 150, 175, 200];                % This can be a single integer or a list (vector) of multiple integers
...
for s = 1:N_sim
    ...
    for i = 1:length(P_ped)
        ...
        run('../utils/simulink_path_selector.m');
